...
public class InSpire {
  ...
  public static void initialize() {
    ...
    if (!tolkDLL.exists()) {
      ...
      try {
        extractFile(
            InSpire.class.getResourceAsStream("/InSpireResources/libs/Tolk.dll"), "Tolk.dll");
        extractFile(
            InSpire.class.getResourceAsStream("/InSpireResources/libs/nvdaControllerClient64.dll"),
            "nvdaControllerClient64.dll");
        extractFile(
            InSpire.class.getResourceAsStream("/InSpireResources/libs/SAAPI64.dll"), "SAAPI64.dll");
      } catch (IOException e) {
